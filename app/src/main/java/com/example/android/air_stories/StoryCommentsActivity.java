...
public class StoryCommentsActivity extends AppCompatActivity {
        ...
        postComment_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(comment_edit_text.getText().length()<1){
                    ...
                    submitStoryComment(shortID, userID, comment_edit_text.getText().toString());
    ...
    public void networkCall() {
        listCall = jsonPlaceHolderApi.getStoryComments(shortID);
...
//        commentsObject.add( new Comments(1, 2, "Ha nice", 4, "Short", "Rake"));
    ...
    private void submitStoryComment(int shortID, int userID, String comment) {
        compositeDisposable.add(myAPI.submitStoryComment(shortID, userID, comment)
